			...
			<div class="swiper-wrapper">
					...
					<div class="auto-container">
						...
						<div class="slider-one_content">
							<div class="slider-one_content-inner">
								<div class="slider-one_title">Structural Steel Detailing Experts</div>
								<h1 class="slider-one_heading">Accurate Shop Drawings for <span>Fabrication Success</span></h1>
								<div class="slider-one_text">Clear and coordinated steel detailing that reduces rework, avoids delays, and keeps fabrication moving.</div>
				...
				<div class="swiper-slide">
					...
					<div class="auto-container">
						...
						<div class="slider-one_content">
							<div class="slider-one_content-inner">
								<div class="slider-one_title">BIM + Connection Design Integration</div>
								<h1 class="slider-one_heading">Coordinated Models with <span>Buildable Connections</span></h1>
								<div class="slider-one_text">From 3D model coordination to connection detailing, we deliver practical outputs ready for site execution.</div>
								<div class="slider-one_button d-flex align-items-center justify-content-center flex-wrap">
									<a href="about.php" class="theme-btn btn-style-two">
										<span class="btn-wrap">
											<span class="text-one">Work With Us</span>
				...
				<div class="swiper-slide">
					...
					<div class="auto-container">
						...
						<div class="slider-one_content">
							<div class="slider-one_content-inner">
								<div class="slider-one_title">Pre-Bid to Project Delivery Support</div>
								<h1 class="slider-one_heading">Engineering Support that <span>Speeds Up Delivery</span></h1>
								<div class="slider-one_text">Estimodeling, detailing, and consultancy aligned to your deadlines, quality standards, and project scope.</div>
								<div class="slider-one_button d-flex align-items-center justify-content-center flex-wrap">
									<a href="about.php" class="theme-btn btn-style-two">
										<span class="btn-wrap">
											<span class="text-one">Work With Us</span>
