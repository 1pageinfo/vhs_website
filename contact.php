<?php include('header.php'); ?>
	...
	<!-- Page Title -->
    <section class="page-title" style="background-image:url(assets/images/section/page-contact-hero.svg)">
			...
			<div class="row clearfix">
				...
				<div class="contact-three_form-column col-lg-7 col-md-6 col-sm-12">
					<div class="contact-three_form-outer">
						...
						<div class="sec-title">
							...
							<h3 class="sec-title_heading">Connect with our <br> engineering team </h3>
						</div>
							...
							<div class="row clearfix">
								...
								<div class="form-group">
									...
									<button class="theme-btn btn-style-three">
										<span class="btn-wrap">
											<span class="text-one">Submit Now <i><img src="assets/images/icons/arrow-1.svg" alt="" /></i></span>
											<span class="text-two">Submit Now <i><img src="assets/images/icons/arrow-1.svg" alt="" /></i></span>
										</span>
									</button>
								</div>
				...
				<div class="contact-three_info-column col-lg-5 col-md-6 col-sm-12">
					<div class="contact-three_info-outer">
						...
						<div class="contact-info_text">ISO 9001-2015 certified structural steel design and detailing company delivering world-class engineering solutions.</div>
						...
						<div class="contact-info_block">
							<div class="contact-info_block-inner">
								...
								<h4>Location</h4>
								<p>Omkar, Unit#301, 3rd floor,<br>Maulana Azad Road, Cross Phadke Road,<br>Subhas Nagar, Dombivli(East),<br>Thane - 421 201, Maharashtra</p>
							</div>
						</div>
						...
						<div class="contact-info_block">
							<div class="contact-info_block-inner">
								...
								<h4>Phone & Email</h4>
								<p>+91 7588639200<br>contact@vhsengg.com</p>
							</div>
						</div>
	...
	<section class="map-one">
		<div class="auto-container">
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3769.123456789012!2d73.0833!3d19.2167!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7b9c0c0c0c0c0%3A0x0!2sOmkar%2C%20Unit%23301%2C%203rd%20floor%2C%20Maulana%20Azad%20Road%2C%20Cross%20Phadke%20Road%2C%20Subhas%20Nagar%2C%20Dombivli%28East%29%2C%20Thane%20-%20421%20201%2C%20Maharashtra!5e0!3m2!1sen!2s!4v1634567890123!5m2!1sen!2s" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
		</div>
	</section>
	<!-- End Map One -->
